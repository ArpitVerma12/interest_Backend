...
////	
////	@Query(value="select * FROM \"customer's_customer\" where customer_id=:customer_id", nativeQuery=true)
////	List<CustomersCustomer> findByCustomerId(@Param("customer_id")String customer_id);
//
//	@Query(value="select * FROM \"customers_customer\" where user_id=:user_id", nativeQuery=true)
//	String findByUserId(@Param("user_id")  String user_id);
//	@Query(value="select * FROM \"customers_customer\" where email_id=:email", nativeQuery=true)
//	NewCustomer findByEmailId(@Param("email") String email);
//	
//	@Query(value="select * FROM \"customers_customer\" where user_id=:user_id", nativeQuery=true)
//	CustomersCustomer findByUserId1(@Param("user_id") String user_id);
//	
//	@Query(value="select * FROM \"customers_customer\" where customer_id=:customer_id", nativeQuery=true)
//	List<CustomersCustomer> findByCustomerId(@Param("customer_id")String customer_id);
//}
